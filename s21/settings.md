...
![info_school.png](img_settings/info_school.png)

[Общая полезная информация](https://21-school-by-students.notion.site/d86aa0253548449885a94bea41b38cc0)
...
Переходим в мой ГоинФри:

**cd /opt/goinfre/gentrifr**

Устанавливаем файлы из git:

**git clone** **https://github.com/Homebrew/brew** **homebrew**

Открываем файл в корне:
...
```bash
     function brsw {
    eval "$(/opt/goinfre/gentrifr/homebrew/bin/brew shellenv)"
    chmod -R go-w "$(brew --prefix)/share/zsh"
}
```
...
Эту команду я не использвал! (вроде)

**chmod -R go-w "$(brew --prefix)/share/zsh"**

Ещё есть нюансы с перезапуском терминала.

Потом переключение на свой homebrew:

**brsw**

И теперь можно пользоваться им и устанавливать lcov:

**brew install lcov**

# Скрипт очистки школьного Мака
